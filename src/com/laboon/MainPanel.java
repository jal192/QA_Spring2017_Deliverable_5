...
public class MainPanel extends JPanel {
	...
	String in = JOptionPane.showInputDialog("Enter a single char (if > 1, will use first; if none, null (0) char)");
	int toReturn = 0;
	try {
	    toReturn = (int) in.charAt(0);
	} catch (NumberFormatException nfex) {
	    toReturn = 0;
	}
	return toReturn;
	...
	/**
	 * Set up layout, labels and formatting of the MainPanel
	 */
    public MainPanel() {
	super();
